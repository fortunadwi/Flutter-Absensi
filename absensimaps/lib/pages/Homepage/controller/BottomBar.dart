// ignore_for_file: unused_local_variable, prefer_const_constructors_in_immutables, implementation_imports, non_constant_identifier_names, prefer_is_empty, await_only_futures, file_names
...
Future<void> BottomBarChangeUser(index) async {
  switch (index) {
    ...
    case 2:
      Get.toNamed('/profilPageUser');
      break;

    default:
      Get.toNamed('/pageUser');
  }
}
...
Future<void> absensi(Position position, String address, double distance) async {
  ...
  if (distance <= 300) {
    ...
    // Di Luar Area
    Get.snackbar("Warning", "Kamu Berada Di Luar Jangkauan Radius Untuk Absen");
  }
}
