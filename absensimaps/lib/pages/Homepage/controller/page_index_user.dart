...
class PageIndexControllerUser extends StatelessWidget {
  RxBool isLoading = true.obs;
  RxInt pageIndexUser = 0.obs;
  ...
  //     default:
  //       pageIndexUser.value = i;
  //       // Get.snackbar("Warning", "User");
  //       Get.offAllNamed('/pageUser');
  //     // print("Ini Harus USer");
  //   }
  // }
